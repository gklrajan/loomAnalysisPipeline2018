...
msgbox('load your fish file');
[FileName, PathName] = uigetfile('*.bin'); %read fish params
%cd(PathName);

msgbox('load your stim file');
[StimName, stimPathName] = uigetfile('*.bin'); %read stim params
